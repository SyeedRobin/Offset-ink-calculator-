...
# Offset Ink Estimator App
# Developed by Robin Creative Lab (Experimental)
...
st.caption("Supports input in mm (product size) and inches (raw materials). Uses CMYK + Spot Colors.")
...
ink_per_color_g = total_area_m2 * (coverage_percent / 100) * 2  # ISO 2g/m² per color
...
# Footer
st.markdown("---")
st.caption("Created by Robin • Streamlit-powered • Experimental Lab Tool")
